...
- `/`: KPI dashboard with risk trend and channel mix charts (Recharts)
- `/transactions`: searchable/filterable transaction table
- `/alerts`: prioritized fraud alert queue with risk gauge
- `/transactions/:transactionId`: transaction detail with risk + SHAP chart
